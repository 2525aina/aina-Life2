...
aina-Life2は、大切なペットとの日々の生活をサポートし、記録を共有するためのアプリケーションです。
...
| **コミュニケーション** | **チャット機能** | ✅ | ペットの共有メンバーとのグループチャットが可能。 |
...
| | ユーザーのオンライン状態表示 | ⬜ | チャットに参加しているメンバーのオンライン状態を表示する機能。 |
| | メンション機能 | ⬜ | 特定のチャットメンバーを@でメンションする機能。 |
| | リンクプレビュー | ⬜ | チャット内で共有されたURLのプレビューを自動生成する機能。 |
